...
export default function ContractSection() {
    ...
    return (
        <section
            id="contact"
            className="bg-cream-100 py-28 px-[8vw] grid grid-cols-1 md:grid-cols-2 gap-20 items-start"
        >
            {/* 연락처 정보 */}
            <div>
                ...
                <div className="flex flex-col gap-6">
                    <div className="reveal flex gap-4 items-start">
                        <ContactIcon>
                            ...
                            >
                                <path
                                    d="M14 10.7c-1 0-2-.2-3-.5-.3-.1-.6 0-.8.2l-1.3 1.3C7 10.8 5.2 9 4.3 7L5.6 5.7c.2-.2.3-.5.2-.8C5.5 4 5.3 3 5.3 2c0-.5-.5-1-1-1H2c-.5 0-1 .5-1 1C1 9.2 6.8 15 14 15c.5 0 1-.5 1-1v-2.3c0-.5-.5-1-1-1z"
                                    stroke="rgba(232,216,196,0.8)"
                                    strokeWidth="1"
                                    fill="none"
                                />
                            </svg>
                        ...
                        <div>
                            <div className="text-[0.80rem] tracking-[0.12em] text-text-light mb-1">
                                PHONE
                            </div>
                            <div className="font-serif-kr text-[0.95rem] text-brown-900">
                                <a
                                    href="tel:01056255751"
                                    className="hover:text-brown-500 transition-colors duration-400"
                                >
                                    010.5625.5751
                                </a>
                            </div>
                    ...
                    <div className="reveal reveal-delay-1 flex gap-4 items-start">
                        ...
                        <div>
                            ...
                            <div className="font-serif-kr text-[0.95rem] text-brown-900">
                                <a
                                    href="mailto:612057ekp@naver.com"
                                    className="hover:text-brown-500 transition-colors duration-400"
                                >
                                    612057ekp@naver.com
                                </a>
            ...
            <form
                ref={formRef}
                action={handleAction}
                className="reveal reveal-delay-2 flex flex-col gap-4"
            >
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div className="flex flex-col gap-1.5">
                        <label className="text-[0.80rem] tracking-widest text-text-light">
                            성함 *
                        </label>
                        <input
                            name="name"
